...
import {BsFillWebcamFill, BsFillDatabaseFill} from 'react-icons/bs';
import {BiMobile} from 'react-icons/bi';
import {AiOutlineCloud, AiOutlineSecurityScan, AiOutlineDatabase} from 'react-icons/ai';
    ...
    <div name='services' className='w-[80%] mx-auto'>
         <div className='py-12 sm:py-20'>
            ...
            <div className='grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 gap-y-10 sm:gap-y-16'>
               ...
               <div className='flex flex-col justify-center items-center gap-2 '>
                  <BiMobile className='text-purple-500 text-[70px] sm:text-[100px]'></BiMobile>
               ...
               <div className='flex flex-col justify-center items-center gap-2 '>
                  <AiOutlineCloud className='text-purple-500 text-[70px] sm:text-[100px]'></AiOutlineCloud>
               ...
               <div className='flex flex-col justify-center items-center gap-2 '>
                  <AiOutlineSecurityScan className='text-purple-500 text-[70px] sm:text-[100px]'></AiOutlineSecurityScan>
               ...
               <div className='flex flex-col justify-center items-center gap-2 '>
                  <AiOutlineDatabase className='text-purple-500 text-[70px] sm:text-[100px]'></AiOutlineDatabase>
               ...
               <div className='flex flex-col justify-center items-center gap-2 '>
                  <BsFillDatabaseFill className='text-purple-500 text-[70px] sm:text-[100px]'></BsFillDatabaseFill>
