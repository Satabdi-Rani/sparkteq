        ...
        <div className='w-[80%] mx-auto py-24 text-white '>
            ...
            <div className='grid grid-col-1 sm:grid-cols-4 gap-10 sm:gap-2 '>
                <div className='flex flex-col items-center gap-2 sm:gap-4 '>
                    <h1  className='text-6xl sm:text-5xl  lg:text-7xl font-bold animate-slide-in'>15</h1>
                    <p className='text-md sm:text-md lg:text-xl xl:text-2xl animate-slide-in'>Years of Experience</p>
                </div>
